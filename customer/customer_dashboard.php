...
if (!isset($_SESSION['customer_id'])) {
  header("Location: ../public/login.php?redirect=" . urlencode($_SERVER['PHP_SELF']));
  exit();
}
...
// 3️⃣ Regenerate session ID every 10 minutes for security
if (!isset($_SESSION['CREATED'])) {
    $_SESSION['CREATED'] = time();
} else if (time() - $_SESSION['CREATED'] > 600) {
    session_regenerate_id(true); // change session ID, keep data
      ...
      <div>
        ...
        <div class="notify-box">
          ...
          <div style="margin-top:12px;display:flex;gap:8px;justify-content:space-between;align-items:center">
            <a class="btn" href="my_reservations.php">View Reservations</a>
        ...
        <div style="display:flex;gap:10px;margin-top:8px;flex-wrap:wrap">
          <a class="btn" href="../public/menu.php">Order Food</a>
           <a class="btn" href="../public/reservation.php">Reserve Table</a>
          <a class="btn" href="editprofile.php">Edit Profile</a>
          <a class="btn" href="../public/logout.php">Logout</a>
        </div>
      </div>
    </div>

    ...
    <table>
      ...
      <tr>
        ...
        <td> <img width="150" height="80" src="../photos/<?php echo $row['image']; ?>" alt=""></td>
         ...
         <td> <a href="../includes/view.php?id=<?php echo $row['menu_id']; ?>">View</a> | <a href="../includes/edit.php?id=<?php echo $row['menu_id']; ?>">edit</a> | <a href="../includes/delete.php?id=<?php echo $row['menu_id'] ?>">delete</a></td>
      </tr>
